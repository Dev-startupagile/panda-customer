        ...
        body: SingleChildScrollView(
            child:  Consumer<ProfileProvider>(
                builder: (context,value,child) {
                  ...
                  Padding(
                    padding:  EdgeInsets.fromLTRB(height*0.01, height*0.05, height*0.01,0),
                    child: Column(
                      ...
                      children: [
                        ...
                        Material(
                          ...
                          color: KBGColor,
                          child: ListTile(
                            leading: profileAvatar(value.customerprofile?.personalInformation.profilePicture, null, true),
                            title:  Text(
                              value.customerprofile?.personalInformation.fullName ?? "",
                              textScaleFactor: 1.1,
                            ),
                            subtitle: Text(value.customerprofile?.personalInformation.id ?? ""),
                            trailing: TextButton(
                              onPressed: () {
                                editProfile();
                              },
                        ...
                        const Center(
                            ...
                            Padding(
                              ...
                              child: Text("no vehicle",style: TextStyle(fontSize: 16),),
                            ))
                            :
                        SizedBox(
                          height: height * 0.33,
                                          ...
                                          child: Column(
                                            ...
                                            children: [
                                              ...
                                              Align(
                                                ...
                                                child: IconButton(
                                                    onPressed: (){
                                                      deleteVehicle(value.customerprofile?.vehicles.items[index].id);
                                                    },
                        ...
                        customListTile(Icons.note_add, "Term of Services", Icons.arrow_forward_ios_sharp, termOfservices,null ),

                        SizedBox(
                          height: height*0.02,
                        ),

                        customListTile(Icons.privacy_tip, "Privacy Policy", Icons.arrow_forward_ios_sharp, privacyPolicy,null),

                        SizedBox(
                          height: height*0.02,
                        ),

                        customListTile(Icons.help, "Help", Icons.arrow_forward_ios_sharp, help,null),

                        SizedBox(
                          height: height*0.04,
                        ),

                        customListTile(Icons.question_mark, "FAQ", Icons.arrow_forward_ios_sharp, faq,null),
                        ...
                        customListTile(Icons.contact_support, "Contact Us", Icons.arrow_forward_ios_sharp, contactUs,null),

                        SizedBox(
                          height: height*0.04,
                        ),

                        customListTile(Icons.settings, "Settings", Icons.arrow_forward_ios_sharp, settings,null),
                        ...
                        customListTile(Icons.logout, "Logout", Icons.arrow_forward_ios_sharp, logout,null),

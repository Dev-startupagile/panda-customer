...
class serviceRequestForm extends StatelessWidget {
  ...
  serviceRequestForm({required this.setServiceId,required this.serviceType,this.getFunc, Key? key}) : super(key: key);
                ...
                ListView.builder(
                  ...
                  itemBuilder: (context,index){
                    ...
                    return  Padding(
                      ...
                      child: Card(
                        shape:serviceType == req.title? const RoundedRectangleBorder(

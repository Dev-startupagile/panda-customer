...
class WhereAreYou extends StatefulWidget {
  ...
  WhereAreYou({required this.removeVehicleId, required this.currentLocationSetter, required this.imageInit, required this.currentPlaceAddress, required this.dateTime, required this.pickDateTime,   required this.images, required this.setVehicleId, required this.vehicleId, required this.serviceType, required this.dropdownValue,required this.getSetDropdownFunc, required this.isNotePressed,required this.getNotePressedFunc, required this.getFunc,required this.locationController,required this.destinationController,required this.noteController, Key? key}) : super(key: key);
...
class _WhereAreYouState extends State<WhereAreYou> {
  ...
  List<String> dropdownItems = [ serviceTypeOne, serviceTypeTwo,serviceTypeThree, serviceTypeFour];
 final ImagePicker imagePicker = ImagePicker();
  ...
  Future _uploadProfilePic(BuildContext context) async {
    if (widget.images.isNotEmpty) {
        context.read<UploaderProvider>().maltiImageUploader(context, widget.images );
    }
  }
        ...
        widget.isNotePressed?
          Column(
            children: [
              ...
              customNoteTextField(Icons.note, "text", widget.noteController, "Notes", context, widget.getFunc )
            ],
          )
            :
           Column(
                  ...
                  children: [
                    ...
                    Column(
                          ...
                          children: [
                            ...
                            customServiceTextField(Icons.location_pin,onChangeFunc, "text", widget.locationController, "Service Location", context, widget.getFunc),
                            ...
                            InkWell(
                              onTap: () {
                                setState(() {
                                  if(widget.currentPlaceAddress != null){
                                    widget.locationController.text = widget.currentPlaceAddress ?? "";
                                    serviceLocationQuery = null;
                                  }
                              ...
                              child: ListTile(
                                ...
                                title: Text(widget.currentPlaceAddress ?? "We are finding your current location"),
                              ),
                                        ...
                                        return Column(
                                          children: [
                                            InkWell(
                                              onTap: () {
                                                setState(() {
                                                  widget.locationController.text = req?.description ?? "";
                                                  serviceLocationQuery = null;
                          ...
                          Padding(
                            ...
                            child: SizedBox(
                              ...
                              child: ListView.builder(
                                    itemCount: value.customerprofile?.vehicles.items.length,
                                    shrinkWrap: false,
                                      ...
                                      return
                                        InkWell(
                                          onTap: (){
                                            ...
                                            //
                                            // }
                                            widget.setVehicleId(value.customerprofile?.vehicles.items[index].id);
                                          },
                                          child: Card(
                                                shape:widget.vehicleId == value.customerprofile?.vehicles.items[index].id?
                                                ...
                                                child: SingleChildScrollView(
                                                  child: Column(
                                                      ...
                                                      children: [
                                                        ...
                                                        vehicleAvatar(true, value.customerprofile?.vehicles.items[index].image ?? "",null),
                                                        ...
                                                        Row(
                                                          ...
                                                          children: [
                                                            ...
                                                            Icon(
                                                                ...
                                                                size: 30,
                                                                color: Color(int.parse("0xff${ value.customerprofile?.vehicles.items[index].color}"))
                                                            )
                                                          ],
                                                        ),
                                                      ],
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        TextButton(
                          onPressed: () {
                            displayInfoSnackBar(context, "You already selected vehicle");
                          },
                          child:  Text(
                            'ADD VEHICLE',
                              ...
                              child: Column(
                                children: [
                                  ...
                                  Material(
                                      ...
                                      color: Colors.white,
                                      child:
                                      customServiceListTile(null, DateFormat('MM/dd/yyyy hh:mm a').format(widget.dateTime), Icons.arrow_forward_ios_sharp, timePressed)
                                  ),
                        ...
                        child: Column(
                          children:  [
                            ...
                            Column(
                              children: [
                                Material(
                                    ...
                                    color: Colors.white,
                                    child:
                                    customServiceListTile(Icons.line_style_rounded, "Notes", Icons.arrow_forward_ios_sharp, notesPressed),
                                ),

                                Visibility(
                                  visible: widget.noteController.text.isNotEmpty,
                                    child: Text( widget.noteController.text.length > 20 ? '${widget.noteController.text.substring(0, 19)} ...' : widget.noteController.text,style: KHintTextStyle))
                            ...
                            Material(
                              ...
                              child: Column(
                                children: [
                                  customServiceListTile(Icons.photo, "Attach Photos", Icons.arrow_forward_ios_sharp, attachPhotos),
                                  Wrap(
                                    children: [
                                        ...
                                        Container(
                                          ...
                                          child: Stack(
                                            children: [
                                              ...
                                              Visibility(
                                                visible: context.read<UploaderProvider>().uploadedFileList.length == widget.images.length,
                                                child: Align(
                                                  ...
                                                  RawMaterialButton(
                                                    onPressed: () {
                                                        ...
                                                        context.read<UploaderProvider>().removeMultiImage(i);
                                  ...
                                  Visibility(
                                    visible: context.watch<UploaderProvider>().isMultiLoading,
                                      child: const

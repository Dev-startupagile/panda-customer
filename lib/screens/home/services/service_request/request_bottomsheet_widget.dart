...
class RequestBottomSheetWidget extends StatefulWidget {
  ...
  @override
  State<RequestBottomSheetWidget> createState() =>
      _RequestBottomSheetWidgetState();
}
...
class _RequestBottomSheetWidgetState extends State<RequestBottomSheetWidget> {
  ...
  void currentServiceLocationSetter() async {
    final address = await geocoder.findAddressesFromCoordinates(
        Coordinates(widget.latitude, widget.longtude));
    setState(() {
  ...
  void requestService() async {
    ...
    AddServiceRequestModel addServiceRequestModel = AddServiceRequestModel(
        serviceId: serviceId,
    ...
    await context.read<ServiceRequestProvider>().sendServiceRequest(
        context,
  ...
  void cancelServiceRequest() {
    context
        ...
        .cancelServiceRequest(context, serviceId);
  }
  ...
  void refreshNearByTech() {
    WidgetsBinding.instance.addPostFrameCallback((_) {
      context
          .read<NearByProvider>()
          .nearBy(context, widget.latitude, widget.longtude, backToHome, false);
    });
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: SizedBox(
        height:
            widget.title == assignedTechnician ? height * 0.15 : height * 0.85,
                    ...
                    Visibility(
                        ...
                        child: Form(
                            ...
                            child: WhereAreYou(
                              ...
                              getSetDropdownFunc: setDropdownValue,
                              isNotePressed: isNotePressed,
                              getNotePressedFunc: notePressed,
                              getFunc: onClickNext,
                              locationController: locationController,
                              destinationController: destinationController,
                              noteController: noteController,
                              currentPlaceAddress: currentPlaceAddress,
                              imageInit: imageInit,
                            ))),
                    Visibility(
                    ...
                    Visibility(
                      ...
                      child: Visibility(
                        ...
                        child: ElevatedButton(
                          onPressed: () {
                            isNotePressed ? onClickSave() : onClickNext();
                          },

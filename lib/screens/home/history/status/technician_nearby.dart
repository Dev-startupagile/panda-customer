...
class NearByTechnician extends StatefulWidget {
  double latitude;
  double longitude;
  NearByTechnician({ required this.latitude,required this.longitude, Key? key}) : super(key: key);

  @override
  State<NearByTechnician> createState() => _NearByTechnicianState();
}

class _NearByTechnicianState extends State<NearByTechnician> with TickerProviderStateMixin {
                      ...
                      children: [
                        ...
                        ListView.builder(
                          ...
                          itemBuilder: (context,index){
                            ...
                            return MechanicsProfile(mechanicProfile: req,sendServiceRequest:sendServiceRequest);

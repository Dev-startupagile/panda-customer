...
Widget historyListTile( status, titleText,subtitleText,date,actionMethod,Datum req,reqStatus) =>
    InkWell(
      onTap: (){
        actionMethod(req);
      },
              ...
              trailing: Column(
                children: [
                  ...
                  Visibility(
                    ...
                    child: Text(reqStatus,style: const TextStyle(color:kPrimaryColor),)
                  ),

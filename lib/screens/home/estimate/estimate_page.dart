...
class _EstimatePageState extends State<EstimatePage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        child: SingleChildScrollView(
          ...
          Column(
              ...
              children: [
                ...
                EstimateDetail(hideDetail:hideDetail,refreshPage: fetchEstimate, estimateDetail: estimateDetail, estimationSetter: estimationSetter,)
              ]
          )
              :
                            ...
                            InkWell(
                              ...
                              child: Card(
                                child: Column(
                                  ...
                                  children: [
                                      ListView.builder(
                                        itemCount: req.vehiclesDetail.length,
                                        shrinkWrap: true,
                                        controller: _scrollController,
                                        itemBuilder: (context,index){
                                        return  ListTile(
                                              leading: vehicleAvatar(false,req.vehiclesDetail[index].image, null),
                                              title: Text(req.vehiclesDetail[index].model ?? "",style: KLatoTextStyle,) ,
                                              subtitle: Text(req.vehiclesDetail[index].model ?? "",style: KLatoRegularTextStyle,),
                                    ...
                                    ListTile(
                                      title:  Text(req.title ?? "",style: KAppTitleTextStyle,),
                                      subtitle: Text(req.note.length > 20 ? '${req.note.substring(0, 20)}...' : req.note,style: KHintTextStyle)
                                    ),
      ...
      bottomSheet:  title != -1 ?  ReSchedulePage(

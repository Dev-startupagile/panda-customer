...
Widget profileAvatar(profileUrl,image, bool isHomeScreen, ){
  return Card(
    elevation: 2.0,
    ...
    child: CircleAvatar(
      ...
      CachedNetworkImage(
        ...
        errorWidget: (context, url, error) => Image.asset("lib/assets/avater.png"),
      ),
    ),
  );
}
  ...
  return Card(
    ...
    child: Container(
      ...
      CachedNetworkImage(
        ...
        errorWidget: (context, url, error) => Image.asset("lib/assets/addCar.png"),
      ),
    ),
  );
}